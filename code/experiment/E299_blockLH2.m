...
for t= next_trial:next_trial+nTrials-1
    ...
    if response==0
      ...
      if (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 1 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 2 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 1 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 2 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 1 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 2 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 1 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 0 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 2 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 1 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 2 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 1 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 0 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 2 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 1 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 1 && result.trial_blockType(t) == 2 && result.trial_response(t) == 1) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 1 && result.trial_response(t) == 2) || ...
         (result.trial_crossed_leg(t) == 1 && result.trial_crossed_hand(t) == 1 && result.trial_limbside(t) == 2 && result.trial_blockType(t) == 2 && result.trial_response(t) == 2))
